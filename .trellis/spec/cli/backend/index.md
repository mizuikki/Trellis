...
| [Release Process](./release-process.md) | Source-managed release, package versioning, and manifest continuity | Done |
| [Trellis Core SDK](./trellis-core-sdk.md) | `@mizuikki/trellis-core` / CLI package boundary, public exports, build and versioning contracts | Done |
...
| [`trellis upgrade` Command](./commands-upgrade.md) | Removed command and source-checkout rebuild guidance | Done |
...
- Script work (including `task.py scaffold`, start gates for optional planning
  artifacts, or the canonical scaffold module) → [script-conventions.md](./script-conventions.md)
...
- Preparing a source-managed release or migration manifest → [release-process.md](./release-process.md)
- Editing `packages/core/**`, moving reusable CLI logic into core, or changing CLI imports from `@mizuikki/trellis-core` → [trellis-core-sdk.md](./trellis-core-sdk.md)
