...
3. Use ABCoder or language-native tooling for exact signatures, types, class boundaries, dependency relationships, and implementation examples.
4. Read representative source and test files directly before turning any finding into a spec rule.
