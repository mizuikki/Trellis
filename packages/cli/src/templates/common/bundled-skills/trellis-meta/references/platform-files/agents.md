...
| Kimi Code | `.kimi-code/skills/trellis-*/SKILL.md` (agent prompts as skills; `trellis-research` dispatches to `explore`, while `trellis-implement` and `trellis-check` dispatch to `coder`) |
