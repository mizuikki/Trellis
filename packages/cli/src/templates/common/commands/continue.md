...
- `status=planning` + complex task missing either `design.md` or `implement.md` → **1.1** and run `{{PYTHON_CMD}} ./.trellis/scripts/task.py scaffold <task> all`, then fill and review both artifacts.
